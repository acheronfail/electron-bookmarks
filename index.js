...
/**
 * @START MOVE INTO SEPARATE FILES
 */
...
const fileDialogProperties = dialog.fileDialogProperties = {
  openFile: 1 << 0,
  openDirectory: 1 << 1,
  multiSelections: 1 << 2,
  createDirectory: 1 << 3,
 ...
 */
dialog.showOpenDialog = function showOpenDialog(win, opts = {}, cb) {
  checkAppInitialized();
